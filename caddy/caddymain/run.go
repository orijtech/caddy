...
func init() {
	...
	flag.Float64Var(&traceSamplerRate, "trace-sampler-rate", 0.001, "If set to > 0 signifies the trace sampling probability\n\te.g 0.1 to trace 1 in 10 requests.\n\tDefault is 1 in 1000 or 0.001")
